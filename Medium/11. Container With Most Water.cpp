    ...
    int maxArea(vector<int>& height) {
        ...
        for(left = 0; left < height.size()-1; left++){
            for(right = left+1; right < height.size(); right++){
                cout<< "left:"<<left<<":"<<height[left]<<"/right:"<<right<<":"<<height[right]<<endl;
